...
public class ToyMemberAdapter1 extends BaseQuickAdapter<QueryToyMemberReSBean.BODYBean.LSTBean, MyViewHolder> {
    private Context context;

    public ToyMemberAdapter1(FragmentActivity activity, int manager_gridview_item, List<QueryToyMemberReSBean.BODYBean.LSTBean> lst) {
