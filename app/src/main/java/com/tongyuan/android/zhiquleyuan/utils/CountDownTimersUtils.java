...
/**
 * Created by DTC on 2017/11/610:11.
 */

public class CountDownTimersUtils extends CountDownTimer {
    ...
    public CountDownTimersUtils(TextView textView, long millisInFuture, long countDownInterval) {
