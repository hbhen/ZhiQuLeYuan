...
import static com.tongyuan.android.zhiquleyuan.activity.ActivityLogin.MINELOGINOK;
...
//                    Intent intent7 = new Intent();
                    mIntent.setClass(getContext(), ActivityLogin.class);
                    Log.i("log", "onClick: ______------");
//                    getActivity().startActivity(mIntent);
                    startActivityForResult(mIntent, MINELOGIN);
...
//                            Intent babyInfoListIntent = new Intent();
...
//                Intent intent6 = new Intent();
            ...
            case R.id.ll_fragment_mine_logout:
                ...
                mToken1 = SPUtils.getString(getActivity(), "TOKEN", "");

                ToastUtil.showToast(getActivity(), "退出成功");
                //TODO 把退出登录隐藏
                mMyLogout.setVisibility(View.GONE);
                Log.i("TOKEN", "TOKEN: " + mToken1);

                //TODO 这里应该有一个刷新页面的功能!!未完成!
                break;
...
//                Intent intent8 = new Intent();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (resultCode) {
            case MINELOGINOK:
                ...
                mUserimg = extras.getString("userimg");
    ...
    public void onResume() {
        ...
        if (!mToken.equals("")) {
            ...
            Glide.with(getContext()).load(R.mipmap.ic_launcher).asBitmap().into(mPic);
            mMyLogout.setVisibility(View.GONE);
        }
    }
}