...
import com.tongyuan.android.zhiquleyuan.request.cache.CacheData;
import com.tongyuan.android.zhiquleyuan.request.cache.DiskCacheManager;
import com.tongyuan.android.zhiquleyuan.request.cache.Entry;
import com.tongyuan.android.zhiquleyuan.request.cache.MemoryCacheManager;
import com.tongyuan.android.zhiquleyuan.request.config.DataType;
import com.tongyuan.android.zhiquleyuan.request.config.HttpMethod;
import com.tongyuan.android.zhiquleyuan.request.config.Priority;
import com.tongyuan.android.zhiquleyuan.request.config.RequestCacheConfig;
import com.tongyuan.android.zhiquleyuan.request.interfaces.IRequest;
import com.tongyuan.android.zhiquleyuan.request.interfaces.IResponseDelivery;
...
import com.tongyuan.android.zhiquleyuan.request.queue.RequestQueue;
...
import com.tongyuan.android.zhiquleyuan.request.retry.DefaultRetryPolicyImpl;
import com.tongyuan.android.zhiquleyuan.request.retry.RetryPolicy;
import com.tongyuan.android.zhiquleyuan.request.utils.CLog;
...
public abstract class Request<T> implements IRequest<T>, IResponseDelivery<T>, Comparable<Request<T>> {
	...
	/**
	 * Returns the {@link com.tongyuan.android.zhiquleyuan.request.config.Priority} of this request;
	 * {@link com.tongyuan.android.zhiquleyuan.request.config.Priority#NORMAL} by default.
	 */
