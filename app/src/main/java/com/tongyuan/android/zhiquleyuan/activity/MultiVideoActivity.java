...
//                    secondaryProgress = mVolumeInt;
    ...
    private void dialogMoreChoice(final String roomid) {
        final String items[] = new String[toyList.size()];
        final String[] toyItems = toyList.toArray(items);
        ...
        builder.setMultiChoiceItems(toyItems, selected, new DialogInterface.OnMultiChoiceClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                if (isChecked) {
                    ...
                    ToastUtil.showToast(MultiVideoActivity.this, items[which] + "  :true");
                } else {
                    quitToy(roomid, toyItems[which]);
                    ToastUtil.showToast(MultiVideoActivity.this, items[which] + "  :false");
            ...
            private void CallToToy(final String item) {
                ...
                ToastUtil.showToast(MultiVideoActivity.this, "kkk:" + item);
                final String token = SPUtils.getString(MultiVideoActivity.this, "token", "");
                Retrofit retrofit = new Retrofit.Builder().baseUrl(Constant.baseurl)
                        .addConverterFactory(GsonConverterFactory.create())
                        .build();
                AllInterface allInterface = retrofit.create(AllInterface.class);
...
//                        VideoActivity.launch(MultiVideoActivity.this, mBabyimg, mBabyName, roomid, mToken, item, null);
//                        } else {
//                            ToastUtil.showToast(mContext, "不成功: " + response.body().getMsg());
//                        }
...
//                fragmentTransaction.commit();
                    ...
                    public void onFailure(Call<CallToToyRes> call, Throwable t) {
                        ...
                        ToastUtil.showToast(MultiVideoActivity.this, t.toString());
                    }
                });
            }
        });
...
//                }
    ...
    private void seeYou(int peerID) {
        ...
        if (_watchingPeerID == 0) {
            ...
            Session.getInstance().PlayVideo(_watchingPeerID, true, mOther_video, 0, 0, 1, 1, 0, false, 1, 0);
...
//        seeMe();
    ...
    public static void launch(Context context, String roomid, String token, String item, Object o) {
