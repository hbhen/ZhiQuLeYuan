...
public class SwipeMenuAdapter implements WrapperListAdapter,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       SwipeMenuLayout layout = null;
        if (convertView == null) {
            ...
            com.tongyuan.android.zhiquleyuan.view.SwipeMenuListView.SwipeMenu menu = new SwipeMenu(mContext);
    ...
    public void createMenu(com.tongyuan.android.zhiquleyuan.view.SwipeMenuListView.SwipeMenu menu) {
        // Test Code
        com.tongyuan.android.zhiquleyuan.view.SwipeMenuListView.SwipeMenuItem item = new SwipeMenuItem(mContext);
