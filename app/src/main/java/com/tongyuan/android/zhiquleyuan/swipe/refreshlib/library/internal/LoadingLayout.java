 ...
 *******************************************************************************/
package com.tongyuan.android.zhiquleyuan.swipe.refreshlib.library.internal;
...
import com.tongyuan.android.zhiquleyuan.swipe.refreshlib.library.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	private FrameLayout mRefreshImageLayout;
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		switch (scrollDirection) {
			case HORIZONTAL:
				LayoutInflater.from(context).inflate(R.layout.pull_refresh_loading_view, this);
				break;
			case VERTICAL:
			default:
				LayoutInflater.from(context).inflate(R.layout.pull_refresh_loading_view, this);
		...
		mRefreshImageLayout = (FrameLayout) findViewById(R.id.refresh_image_layout);
	...
	public final void refreshing() {
		...
		if(mMode == PullToRefreshBase.Mode.PULL_FROM_END){
			mRefreshImageLayout.setVisibility(View.VISIBLE);
		}
	...
	public final void reset() {
		...
		if (mMode == PullToRefreshBase.Mode.PULL_FROM_END) {
			mRefreshImageLayout.setVisibility(View.GONE);
		} else {
			mRefreshImageLayout.setVisibility(View.VISIBLE);
		}
	}
	...
	public final void showInvisibleViews() {
		...
		if (View.GONE == mHeaderProgress.getVisibility()) {
			mHeaderProgress.setVisibility(View.VISIBLE);
		}
		if (View.GONE == mHeaderImage.getVisibility()) {
			mHeaderImage.setVisibility(View.VISIBLE);
		}
